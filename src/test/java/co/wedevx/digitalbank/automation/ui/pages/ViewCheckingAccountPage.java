...
public class ViewCheckingAccountPage extends BaseMenuPage {
    ...
    public Map<String, String> getNewlyAddedCheckingAccountTransactionInfoMap() {
        ...
        actualResulMap.put("actualCategory",firstRowColumns.get(1).getText());
        actualResulMap.put("actualDescription",firstRowColumns.get(2).getText());
        actualResulMap.put("actualAmount", firstRowColumns.get(3).getText().substring(1));
        actualResulMap.put("actualBalance", firstRowColumns.get(4).getText().substring(1));
    ...
    public Map<String, String> getNewlyAddedCheckingAccountInfoMap(){
        ...
        actualResultMap.put("actualAccountOwnership", actualResult.substring(actualResult.indexOf("Ownership"), actualResult.indexOf("Account Number:")).trim());
