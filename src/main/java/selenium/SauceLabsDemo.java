...
public class SauceLabsDemo {
    public static void main(String[] args) throws MalformedURLException {
        ...
        capabilities.setCapability("platformName", Platform.WIN10); // change to another platform
        capabilities.setCapability("browserName", BrowserType.FIREFOX); // change to another type
